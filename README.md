...
```shell
kubectl cp ./bundle/resources/lib/spid-provider.jar default-sso-in-namespace-deployment-aaabbbccc-dddee:/opt/jboss/keycloak/standalone/deployments -n <NAMESPACE>
```
